...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        InstructorDao.createTable(db, ifNotExists);
        LessonDao.createTable(db, ifNotExists);
        StudentDao.createTable(db, ifNotExists);
        LessonTimeDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        InstructorDao.dropTable(db, ifExists);
        LessonDao.dropTable(db, ifExists);
        StudentDao.dropTable(db, ifExists);
        LessonTimeDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(InstructorDao.class);
        registerDaoClass(LessonDao.class);
        registerDaoClass(StudentDao.class);
        registerDaoClass(LessonTimeDao.class);
